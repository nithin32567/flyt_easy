...
const Demobanner = () => {
    return (
        <div className='w-full min-h-[60vh] md:h-[60vh] relative bg-red-900'>
            ...
            <div className='md:absolute lg:block hidden -translate-y-1/4 w-full h-full z-90 px-4 md:px-0'>
                <SearchForm />
            </div>
