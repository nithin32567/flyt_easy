...
const Demobanner = () => {
  return (
    <div className="w-full min-h-[60vh]  md:h-[60vh] h-[30vh] relative">
      ...
      <div className="absolute -mt-6  sm:top-1/2 top-2/4 px-12 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center z-50 opacity-100 w-full flex flex-col gap-2 md:gap-4  md:px-0">
        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl  leading-tight">
          Fast Booking. <br />
          Great Prices. Smooth Takeoff
        </h1>
        <h3 className="text-xs sm:text-base md:text-lg  leading-relaxed md:max-w-4xl w-full mx-auto">
