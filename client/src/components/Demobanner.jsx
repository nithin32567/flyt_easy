...
const Demobanner = () => {
  return (
    <div className="w-full min-h-[60vh]  md:h-[60vh] h-[30vh] relative">
      ...
      <div className="absolute sm:top-1/2 top-1/3 px-12 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white text-center z-50 opacity-100 w-full flex flex-col gap-2 md:gap-4  md:px-0">
